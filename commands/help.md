...
║                                                                              ║
║  /apple:juice [fix N]       Game-feel audit - celebrations, haptics, sound   ║
║                             Creates: .planning/JUICE.md                      ║
║                                                                               ║
...
| Audit game feel (juice) | `/apple:juice` |
...
| `JUICE.md` | Game-feel audit + fix tiers | `/apple:juice` |
